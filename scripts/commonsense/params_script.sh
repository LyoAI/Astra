...
export MODEL_NAME_OR_PATH="meta-llama/Meta-Llama-3-8B" # Qwen/Qwen2-0.5B meta-llama/Llama-2-7b-hf meta-llama/Meta-Llama-3-8B
...
export OUTPUT_PATH="outputs/commonsense-${INIT_WEIGHTS}-${MODEL_NAME}-r${LORA_RANK}"
...
export SUB_TASK="commonsense:100000"
...
export LOCALHOST="localhost:0,1,2,3,4,5,6,7"
...
export EVAL_DEVICE="0,1,2,3,4,5,6,7"

# Logging arguments
export LOG_FILE="logs/commonsense/${INIT_WEIGHTS}_${MODEL_NAME}-r${LORA_RANK}.log"
export LOG_DIR="logs/log_history/commonsense/${INIT_WEIGHTS}_${MODEL_NAME}-r${LORA_RANK}"
export REPORT_TO="wandb"

# Calibration parameters
export CALIBRATION_DATASET="commonsense"
...
# Helper functions
setup_logging() {
    mkdir -p "logs/log_history/commonsense"
    mkdir -p "logs/commonsense"
